...
def get_args_parser():
    parser = argparse.ArgumentParser('RNN for bitcoin', add_help=False)
    parser.add_argument('--batch-size', default=10, type=int)
    parser.add_argument('--epochs', default=10, type=int)

    # Model parameters

    parser.add_argument('--input-size', default=15, type=int, help='images input size')
    parser.add_argument('--depth', default=12, type=int, help='number of transformer layers')
    parser.add_argument('--hidden_dim', default=64, type=int, help='number of hidden dim in RNN')
    parser.add_argument('--num_layers', default=2, type=int, help='number of layer')
    parser.add_argument('--output_dim', default=1, type=int, help='number of output dim')
    ...
    parser.add_argument('--device', default='mps',
                        help='device to use for training / testing, change to cuda if you have nivida gpu')
    ...
    # FIXME hacky workaround to add model-specific arguments;
...
def main(args):
    ...
    data_loader_train = torch.utils.data.DataLoader(
        ...
        num_workers=int(1.5* args.num_workers),
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('RNN training and evaluation script', parents=[get_args_parser()])
